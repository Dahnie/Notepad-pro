...
const Sidebar = () => {
    return (
        <div className="content sidebar-content col-span-2 fontfam-regular text-base fontfam-regular w-full border-r border-gray-300 pt-16">
            <div className="app-name font-semibold text-lg flex justify-center">Notepad-pro</div>
            <div className="add-color pt-14">
                ...
                <div className="colors p-2 pt-8 w-full justify-center hidden transform transition-all">
